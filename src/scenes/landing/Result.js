...
import {Header,Step, Divider, CheckBox, Price, Slider, MainBikeInfo, ListBikeInfo, DivideLine} from 'components/controls/BaseUtils';
      ...
      <View style={{flex: 1}}>
        ...
        <Container>
          {uiData.map((item, index) => {
            if (item.id === 'TITLE') {
              return <View><Title size={0} width={'35px'} color={themeProp('colorBorder')}>{item.titolo}</Title></View>
            }
