  ...
  return (
    <Container>
      ...
      <View style={{paddingHorizontal: 10, marginTop: 40}}>
        <TitleView>
          <Image width={'100%'} height={'100%'} source={Images.background.haibike_md} />
          <TitleView>
            <View style={{marginRight: 10}}>
              <Text style={{color: themeProp('colorDescription'), fontSize: 15, fontFamily: UniSansBook}}>SCOPRI TUTTE LE</Text>
              <TitleView>
                <Text style={{color: themeProp('colorDescription'), fontSize: 15, fontFamily: UniSansBook}}>eMTB DI</Text>
                <Text style={{color: themeProp('colorDescription'), fontSize: 15, fontFamily: UniSansBold}}>HAIBIKE</Text>
              </TitleView>
            </View>
            <Image width={'100%'} height={'100%'} source={Images.icons.arrow_right} style={{marginRight: 10}}/>
            <BadgeView>
              <Title size={isIOS ? '8px' : '0'} color={themeProp('colorSecondary')} width={'20px'}>59</Title>
            </BadgeView>
          </TitleView>
        </TitleView>
        <DivideLine/>
...
export default BikePagePremium;
